...
from deorder import common as Dc

class MergePluginsHideWindow(QtWidgets.QDialog):
    ...
    def __init__(self, organizer, parent = None):
        ...
        super(MergePluginsHideWindow, self).__init__(parent)
...
class MergePluginsHide(mobase.IPluginTool):
    ...
    def __init__(self):
        ...
        super(MergePluginsHide, self).__init__()
    ...
    def display(self):
        self.__window = MergePluginsHideWindow(self.__organizer)
